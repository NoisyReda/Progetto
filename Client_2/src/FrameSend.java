 ...
 */
public class FrameSend extends javax.swing.JFrame {

    private Invia i;

    /**
     * Creates new form FrameSend
     */
    public FrameSend() {
        initComponents();
        i = new Invia();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jTextField2.getText().equals("")) {
            try {
                Condivisa.getInstance().setAddress(InetAddress.getByName(jTextField2.getText()));
                Condivisa.getInstance().setMessaggio("a" + Condivisa.getInstance().getNome());
                i.send();
                this.setVisible(false);
                new Main().setVisible(true);
            } catch (IOException ex) {
                Logger.getLogger(FrameSend.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
